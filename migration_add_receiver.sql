...
CREATE PROCEDURE MigrationsScript()
BEGIN
    IF NOT EXISTS(SELECT 1 FROM `__EFMigrationsHistory` WHERE `MigrationId` = '20260716062158_AddReturnReceiverName') THEN

    ALTER TABLE `WarehousePartBorrows` ADD `ReturnReceiverName` varchar(200) CHARACTER SET utf8mb4 NULL;
...
BEGIN
    ...
    INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
    VALUES ('20260716062158_AddReturnReceiverName', '8.0.11');
