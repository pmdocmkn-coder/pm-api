...
namespace Pm.Migrations
{
    public partial class AddRadioRepairEcosystem : Migration
    {
        ...
        {
            migrationBuilder.DropTable(name: "WarehousePartBorrowStatusLogs");
            migrationBuilder.DropTable(name: "WarehousePartBorrows");
            migrationBuilder.DropTable(name: "RadioHandoverAccessories");
            migrationBuilder.DropTable(name: "RadioHandovers");
            migrationBuilder.DropTable(name: "RadioRepairJobStatusLogs");
            migrationBuilder.DropTable(name: "RadioRepairJobs");
        }
    }
}
